 ...
 */
    ...
    #define HSI48_VALUE                                                                       \
        48000000UL /*!< Value of the Internal High Speed oscillator for USB OTG FS/RNG in Hz. \
 ...
 */
    ...
    #define LSI_VALUE                                                     \
        32000UL /*!< LSI Typical Value in Hz.                             \
...
/**
 * @brief  For code optimization purpose, uncomment and set to "1U" the USE_HAL_CRYP_ONLY or
 * USE_HAL_SAES_ONLY, to use only one peripheral. Both defines cannot be set to "1U" at the same
 * time.
 */
