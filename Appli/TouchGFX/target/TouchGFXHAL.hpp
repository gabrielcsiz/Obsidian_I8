...
class TouchGFXHAL : public TouchGFXGeneratedHAL {
   public:
    /**
     * @fn TouchGFXHAL::TouchGFXHAL(touchgfx::DMA_Interface& dma, touchgfx::LCD& display,
     * touchgfx::TouchController& tc, uint16_t width, uint16_t height) : TouchGFXGeneratedHAL(dma,
     * display, tc, width, height)
     *
     * @brief Constructor.
     *
     ...
     */
    TouchGFXHAL(touchgfx::DMA_Interface& dma, touchgfx::LCD& display,
                touchgfx::TouchController& tc, uint16_t width, uint16_t height)
    ...
    /**
     * @fn virtual bool TouchGFXHAL::blockCopy(void* RESTRICT dest, const void* RESTRICT src,
     * uint32_t numBytes);
     *
