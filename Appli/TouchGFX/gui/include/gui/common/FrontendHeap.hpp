...
class FrontendHeap : public FrontendHeapBase {
   public:
    ...
    typedef touchgfx::meta::TypeList<touchgfx::meta::Nil,  // Replace this with first user-defined
                                                           // type
    ...
    typedef touchgfx::meta::TypeList<
        MaxGeneratedViewType, touchgfx::meta::TypeList<MaxUserViewType, touchgfx::meta::Nil> >
        CombinedViewTypes;
    ...
    typedef touchgfx::meta::select_type_maxsize<UserDefinedPresenterTypes>::type
        MaxUserPresenterType;
    ...
    typedef touchgfx::meta::select_type_maxsize<UserDefinedTransitionTypes>::type
        MaxUserTransitionType;
   ...
   private:
    FrontendHeap() : FrontendHeapBase(presenters, views, transitions, app), app(model, *this) {
        gotoStartScreen(app);
    }
};
