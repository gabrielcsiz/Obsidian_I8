...
void MX_EXTMEM_MANAGER_Init(void)
{
  ...
  extmem_list_config[1].PsramObject.psram_public.FreqMax = 150 * 1000000u;
  extmem_list_config[1].PsramObject.psram_public.NumberOfConfig = 0u;

  /* Memory command configuration */
  extmem_list_config[1].PsramObject.psram_public.ReadREG           = 0xE0u;
  extmem_list_config[1].PsramObject.psram_public.WriteREG          = 0x60u;
