...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_2|GPIO_PIN_0;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF9_XSPIM_P1;
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  /* USER CODE END XSPI1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOO, GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_2|GPIO_PIN_0);
  ...
  /* USER CODE END XSPI2_MspDeInit 0 */
    ...
    PN1     ------> XSPIM_P2_NCS1
    */
    HAL_GPIO_DeInit(GPION, GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_2
                          |GPIO_PIN_3|GPIO_PIN_1);
